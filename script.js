...
function loadData(){
    ...
    //grabbing city from input field
    ...
    $.ajax({
        ...
        if(currentWeather.includes("cloud")){
            var $img = `<img class="p-3" src="https://img.icons8.com/dusk/48/000000/cloud.png"/>`
            ...
            var $img = `<img class="p-3" src="https://img.icons8.com/dusk/48/000000/apple-weather.png"/>`

        }
        else if(currentWeather.includes("rain")){
            var $img = `<img class="p-3" src="https://img.icons8.com/cotton/48/000000/rain--v1.png"/>`
        }
        else if(currentWeather.includes("storm")||currentWeather.includes("thunder")){
            var $img = `<img class="p-3" src="https://img.icons8.com/color/48/000000/storm.png"/>`
        }
        else{
            var $img = `<img class="p-3" src="https://img.icons8.com/dusk/48/000000/partly-cloudy-night.png"/>`
        ...
        var htmlCityList = `
                ...
                <li id="list" class="list-group-item d-flex justify-content-between align-items-center p-3">
        ...
        $.ajax({
            ...
            if(uvIndex<3){
                ...
                uvIndexDiv.attr("class","d-inline border rounded bg-success text-white p-1")
                ...
                uvIndexDiv.attr("class","d-inline border rounded bg-warning text-white p-1")
                uvIndexDiv.attr("id","indexDiv")
                uvIndexDiv.text(uvIndex)
            ...
            for(let i=1;i<6;i++){
                ...
                if(weatherForecast.includes("cloud")){
                    var $imgF = `<img class="p-3" src="https://img.icons8.com/dusk/40/000000/cloud.png"/>`

                }
                else if(weatherForecast.includes("sun")||weatherForecast.includes("clear")){
                    var $imgF = `<img class="p-3" src="https://img.icons8.com/emoji/40/000000/sun-emoji.png"/>`

                }
                else if(weatherForecast.includes("partly")){
                    var $imgF = `<img class="p-3" src="https://img.icons8.com/dusk/40/000000/apple-weather.png"/>`
...
//creating links from list items
        ...
        $.ajax({
            ...
            */
            ...
            $.ajax({
                ...
                localStorage.setItem("htmlData",$("#secondcolumn").html())
                localStorage.setItem(`${cityName}`,$("#secondcolumn").html())
